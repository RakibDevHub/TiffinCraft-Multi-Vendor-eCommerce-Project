...
$router->addRoute('/business/dashboard/food-menu', 'VendorController@listVendorFood', true, ['vendor']);
$router->addRoute('/business/dashboard/food-menu/add-item', 'VendorController@addFoodItem', true, ['vendor']);
$router->addRoute('/business/dashboard/category', 'VendorController@category', true, ['vendor']);
